...
// <i> Default: 3600
// <i> The time in seconds after which the parent shall remove the child from its child table if did not hear from it. Range extenders periodically exchange network-level commands with the coordinator. End devices and sleepy end devices can periodically poll as keep alive mechanism.
...
// <o EMBER_INDIRECT_TRANSMISSION_TIMEOUT_MS> Indirect Queue Timeout in milliseconds<1-30000>
// <i> Default: 8000
// <i> The maximum amount of time (in milliseconds) that the MAC will hold a message for indirect transmission to a child. The maximum value is 30 seconds (30000 milliseconds).
